        ...
        internal const string BuilderForAttribute = @"namespace BuilderGenerator
{
    ...
    public class BuilderForAttribute : System.Attribute
    {
        ...
        internal const string BuildMethodInitializer = @"
...
{{Setters}}
        ...
        internal const string BuildMethodConstructor = @"
        public override {{TargetClassFullName}} Build()
        {
            if (Object?.IsValueCreated != true)
            {
...
{{Parameters}}
        ...
        internal const string BuildMethodConstructorParameter = "                        {{PropertyName}}: {{PropertyName}}.Value,";
