...
using BuilderGenerator.Tests.Integration.Net70.PackageRef.Models.Enums;
using NUnit.Framework;
using Shouldly;
using OrderBuilder = BuilderGenerator.Tests.Integration.Net70.PackageRef.Builders.OrderBuilder;

namespace BuilderGenerator.Tests.Integration.Net70.PackageRef.Tests;
